            ...
            ScrollView(.vertical, showsIndicators: false){
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "Designer", content: "Hamza Rafique Azad")
                        SettingsRowView(name: "Compatibility", content: "iOS 14")
                        SettingsRowView(name: "Github",linkLable: "Hamza Rafique Azad", linkDestination: "https://github.com/HamzaRafiqueAzad")
                        SettingsRowView(name: "LinkedIn",linkLable: "Hamza Rafique Azad", linkDestination: "https://www.linkedin.com/in/hamza-rafique-azad-150381220")
